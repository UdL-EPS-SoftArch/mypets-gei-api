Feature: Disable User
  ...
  Background: It exists an admin and two user accounts created
    Given There is a registered admin with name "admin" and password "password" and email "admin@admin.com"
    And There is a registered user with username "user1" and password "password" and email "user1@user1.com"
    And There is a registered user with username "user2" and password "password" and email "user2@user.com"
